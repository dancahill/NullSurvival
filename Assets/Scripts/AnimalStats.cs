...
public class AnimalStats
{
	...
	public static List<Stats> Animals = new List<Stats>
	{
		...
		new Stats { name="Viper",                     baseHealth= 50,                maxSpeed = 1.2f,                                           },
		...
		new Stats { name="Velociraptor",              baseHealth= 50, baseDamage=10, maxSpeed = 30*KPHtoMS, turnSpeed = 3.0f, chanceToSpawn=40  }  // 64 kph is too fast
	};
}
